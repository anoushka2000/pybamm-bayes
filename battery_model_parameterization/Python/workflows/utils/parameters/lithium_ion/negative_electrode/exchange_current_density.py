...
def _graphite_electrolyte_exchange_current_density_Dualfoil1998(c_e, c_s_surf, T, alpha_input, j0_input):
    """
...
def graphite_electrolyte_exchange_current_density_Dualfoil1998(alpha_input, j0_input):
    return partial(_graphite_electrolyte_exchange_current_density_Dualfoil1998,
                   alpha_input=alpha_input,
                   j0_input=j0_input)


def _graphite_LGM50_electrolyte_exchange_current_density_Chen2020(c_e, c_s_surf, T, alpha_input, j0_input):
    """
    Exchange-current density for Butler-Volmer reactions between graphite and LiPF6 in
    EC:DMC.
    References
...
def graphite_LGM50_electrolyte_exchange_current_density_Chen2020(alpha_input, j0_input):
    return partial(graphite_LGM50_electrolyte_exchange_current_density_Chen2020,
                   alpha_input=alpha_input,
                   j0_input=j0_input)


def _graphite_electrolyte_exchange_current_density_PeymanMPM(c_e, c_s_surf, c_s_max, T, alpha_input, j0_input):
    """
    Exchange-current density for Butler-Volmer reactions between graphite and LiPF6 in
    EC:DMC.
...
def graphite_electrolyte_exchange_current_density_PeymanMPM(alpha_input, j0_input):
    return partial(_graphite_electrolyte_exchange_current_density_PeymanMPM,
                   alpha_input=alpha_input,
                   j0_input=j0_input)