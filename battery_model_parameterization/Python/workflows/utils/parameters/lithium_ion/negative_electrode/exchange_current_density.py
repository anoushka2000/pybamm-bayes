...
def graphite_electrolyte_exchange_current_density_Dualfoil1998_j0(c_e, c_s_surf, T):
    """
...
def graphite_electrolyte_exchange_current_density_Dualfoil1998_alpha(c_e, c_s_surf, T):
    """
    Modifies pybamm function to allow alpha_n input.
    Exchange-current density for Butler-Volmer reactions between graphite and LiPF6 in
    EC:DMC.
    References
    ----------
...
def graphite_LGM50_electrolyte_exchange_current_density_Chen2020_j0(c_e, c_s_surf, T):
    """
    Exchange-current density for Butler-Volmer reactions between graphite and LiPF6 in
    EC:DMC.
    References
...
def graphite_LGM50_electrolyte_exchange_current_density_Chen2020_alpha(
    c_e, c_s_surf, T
):
    """
    Exchange-current density for Butler-Volmer reactions between graphite and LiPF6 in
...
def graphite_electrolyte_exchange_current_density_PeymanMPM_j0(
...
def graphite_electrolyte_exchange_current_density_PeymanMPM_alpha(
    c_e, c_s_surf, c_s_max, T
):
    """
    Exchange-current density for Butler-Volmer reactions between graphite and LiPF6 in
