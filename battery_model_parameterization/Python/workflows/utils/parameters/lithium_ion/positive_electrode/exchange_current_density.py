...
def lico2_electrolyte_exchange_current_density_Dualfoil1998_j0(c_e, c_s_surf, T):
    """
    Exchange-current density for Butler-Volmer reactions between lico2 and LiPF6 in
    EC:DMC.
    References
...
def lico2_electrolyte_exchange_current_density_Dualfoil1998_alpha(c_e, c_s_surf, T):
    """
    Exchange-current density for Butler-Volmer reactions between lico2 and LiPF6 in
    EC:DMC.
    References
...
def nmc_LGM50_electrolyte_exchange_current_density_Chen2020(c_e, c_s_surf, T):
    ...
    # default value: m_ref = 3.42e-6 (A/m2)(mol/m3)**1.5
...
def nmc_LGM50_electrolyte_exchange_current_density_Chen2020_j0(c_e, c_s_surf, T):
    """
    Exchange-current density for Butler-Volmer reactions between NMC and LiPF6 in
    EC:DMC.
    References
...
def nmc_LGM50_electrolyte_exchange_current_density_Chen2020_alpha(c_e, c_s_surf, T):
    """
    Exchange-current density for Butler-Volmer reactions between NMC and LiPF6 in
    EC:DMC.
    References
...
def NMC_electrolyte_exchange_current_density_PeymanMPM_j0(c_e, c_s_surf, c_s_max, T):
    """
    Exchange-current density for Butler-Volmer reactions between NMC and LiPF6 in
    EC:DMC.
    References
...
def NMC_electrolyte_exchange_current_density_PeymanMPM_alpha(c_e, c_s_surf, c_s_max, T):
    """
    Exchange-current density for Butler-Volmer reactions between NMC and LiPF6 in
    EC:DMC.
    References
