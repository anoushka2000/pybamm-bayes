import pints
import pybamm
from battery_model_parameterization import (MCMCIdentifiabilityAnalysis,
                                            Variable, marquis_2019)
...
identifiability_problem = MCMCIdentifiabilityAnalysis(
    ...
    noise=0.005,
    project_tag="group_meeting_DreamMCMC",
)
identifiability_problem.plot_data()
identifiability_problem.plot_priors()

chains = identifiability_problem.run(
    burnin=1, n_iteration=2000, n_chains=5, n_workers=3, sampling_method="DreamMCMC"
)
